...
message.channel.send({embed});
   ...
   client.users.map(function(user) {
    ...
    } else if(['rpc', 'rcp'].includes(command)) {
    let rock2 = ["бумага! я победил!", "Бумага! ты победил!"]
    let rock1 = Math.floor(Math.random() * rock2.length);
  
    let paper2 = ["Камень! Ты победил!", "Ножницы! Я победил!"]
    let paper1 = Math.floor(Math.random() * paper2.length);
  
    let scissors2 = ["Камень! Я победил!", "Бумага! Ты победил!"]
    let scissors1 = Math.floor(Math.random() * scissors2.length);
  
  let rock = new Discord.RichEmbed()
  .setAuthor("Камень, ножницы, бумага")
  .setColor("#6b5858")
  .addField("Твой выбор", `${args[0]}`)
  .addField("Мой выбор", rock2[rock1])
  
  let paper = new Discord.RichEmbed()
  .setAuthor("Камень, ножницы, бумага")
  .setColor("#6b5858")
  .addField("Твой выбор", `${args[0]}`)
  .addField("Мой выбор", paper2[paper1])
  
  let scissors = new Discord.RichEmbed()
  .setAuthor("Камень, ножницы, бумага")
  .setColor("#6b5858")
  .addField("Твой выбор", `${args[0]}`)
  .addField("Мой выбор", scissors2[scissors1])
  
   /////////////////////////START TYPES/////////////////////////////////////////
  if (message.content === "x!rps rock") message.channel.send(rock)
  if (message.content === "x!rps Rock") message.channel.send(rock)
  if (message.content === "x!rps r") message.channel.send(rock)
  if (message.content === "x!rsp rock") message.channel.send(rock)
  if (message.content === "x!rsp Rock") message.channel.send(rock)
  if (message.content === "x!rsp r") message.channel.send(rock)
	    //language changed//
  if (message.content === "x!rps камень") message.channel.send(rock)
  if (message.content === "x!rps Камень") message.channel.send(rock)
  if (message.content === "x!rps к") message.channel.send(rock)
  if (message.content === "x!rsp камень") message.channel.send(rock)
  if (message.content === "x!rsp Камень") message.channel.send(rock)
  if (message.content === "x!rsp К") message.channel.send(rock)
  /////////////////////////type changed////////////////////////////////////////
  if (message.content === "x!rps paper") message.channel.send(paper)
  if (message.content === "x!rps Paper") message.channel.send(paper)
  if (message.content === "x!rps p") message.channel.send(paper)
  if (message.content === "x!rsp paper") message.channel.send(paper)
  if (message.content === "x!rsp Paper") message.channel.send(paper)
  if (message.content === "x!rsp p") message.channel.send(paper)
	    //language changed//
  if (message.content === "x!rps бумага") message.channel.send(paper)
  if (message.content === "x!rps Бумага") message.channel.send(paper)
  if (message.content === "x!rps б") message.channel.send(paper)
  if (message.content === "x!rsp бумага") message.channel.send(paper)
  if (message.content === "x!rsp Бумага") message.channel.send(paper)
  if (message.content === "x!rsp Б") message.channel.send(paper)
  /////////////////////////type changed/////////////////////////////////////////
  if (message.content === "x!rps scissors") message.channel.send(scissors)
  if (message.content === "x!rps Scissors") message.channel.send(scissors)
  if (message.content === "x!rps s") message.channel.send(scissors)
  if (message.content === "x!rsp scissors") message.channel.send(scissors)
  if (message.content === "x!rsp Scissors") message.channel.send(scissors)
  if (message.content === "x!rsp s") message.channel.send(scissors)
	    //language changed//
  if (message.content === "x!rps ножницы") message.channel.send(scissors)
  if (message.content === "x!rps Ножницы") message.channel.send(scissors)
  if (message.content === "x!rps н") message.channel.send(scissors)
  if (message.content === "x!rsp ножницы") message.channel.send(scissors)
  if (message.content === "x!rsp Ножницы") message.channel.send(scissors)
  if (message.content === "x!rsp Н") message.channel.send(scissors)
  /////////////////////////END TYPES/////////////////////////////////////////
  if (message.content === "x!rps") message.channel.send("Опции: ``камень`` `к`, ``бумага`` `б`, ``ножницы`` `н`. *Usage: +rps <option>*")
  if (message.content === "x!rsp") message.channel.send("Опции: ``камень`` `к`, ``бумага`` `б`, ``ножницы`` `н`. *Usage: +rps <option>*")
  }
});
