...
message.channel.send({embed});
  ...
  .addField("Мой выбор", scissors2[scissors1])
   ...
   /////////////////////////START TYPES/////////////////////////////////////////
  if (args[0] === "x!rps rock") message.channel.send(rock)
  if (args[0] === "x!rps Rock") message.channel.send(rock)
  if (args[0] === "x!rps r") message.channel.send(rock)
  if (args[0] === "x!rsp rock") message.channel.send(rock)
  if (args[0] === "x!rsp Rock") message.channel.send(rock)
  if (args[0] === "x!rsp r") message.channel.send(rock)
	    //language changed//
  if (args[0] === "x!rps камень") message.channel.send(rock)
  if (args[0] === "x!rps Камень") message.channel.send(rock)
  if (args[0] === "x!rps к") message.channel.send(rock)
  if (args[0] === "x!rsp камень") message.channel.send(rock)
  if (args[0] === "x!rsp Камень") message.channel.send(rock)
  if (args[0] === "x!rsp К") message.channel.send(rock)
  /////////////////////////type changed////////////////////////////////////////
  if (message.content === "x!rps paper") message.channel.send(paper)
  if (args[0] === "x!rps Paper") message.channel.send(paper)
  if (args[0] === "x!rps p") message.channel.send(paper)
  if (args[0] === "x!rsp paper") message.channel.send(paper)
  if (args[0] === "x!rsp Paper") message.channel.send(paper)
  if (args[0] === "x!rsp p") message.channel.send(paper)
	    //language changed//
  if (args[0] === "x!rps бумага") message.channel.send(paper)
  if (args[0] === "x!rps Бумага") message.channel.send(paper)
  if (args[0] === "x!rps б") message.channel.send(paper)
  if (args[0] === "x!rsp бумага") message.channel.send(paper)
  if (args[0] === "x!rsp Бумага") message.channel.send(paper)
  if (args[0] === "x!rsp Б") message.channel.send(paper)
  /////////////////////////type changed/////////////////////////////////////////
  if (args[0] === "x!rps scissors") message.channel.send(scissors)
  if (args[0] === "x!rps Scissors") message.channel.send(scissors)
  if (args[0] === "x!rps s") message.channel.send(scissors)
  if (args[0] === "x!rsp scissors") message.channel.send(scissors)
  if (args[0] === "x!rsp Scissors") message.channel.send(scissors)
  if (args[0] === "x!rsp s") message.channel.send(scissors)
	    //language changed//
  if (args[0] === "x!rps ножницы") message.channel.send(scissors)
  if (args[0] === "x!rps Ножницы") message.channel.send(scissors)
  if (args[0] === "x!rps н") message.channel.send(scissors)
  if (args[0] === "x!rsp ножницы") message.channel.send(scissors)
  if (args[0] === "x!rsp Ножницы") message.channel.send(scissors)
  if (args[0] === "x!rsp Н") message.channel.send(scissors)
  /////////////////////////END TYPES/////////////////////////////////////////
